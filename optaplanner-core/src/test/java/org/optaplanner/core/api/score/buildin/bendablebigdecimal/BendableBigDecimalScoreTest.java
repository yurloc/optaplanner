...
public class BendableBigDecimalScoreTest extends AbstractScoreTest {
    ...
    public void parseScore() {
        ...
        assertEquals(scoreDefinitionHSS.createScoreUninitialized(-7,
                                                                 BigDecimal.valueOf(-147), BigDecimal.valueOf(-258),
    ...
    public void toShortString() {
        ...
        assertEquals("[-258/-369]soft",
                     scoreDefinitionHSS.createScore(
                             BigDecimal.valueOf(0), BigDecimal.valueOf(-258),
    ...
    public void testToString() {
        ...
        assertEquals("-7init/[-147]hard/[-258/-369]soft",
                     scoreDefinitionHSS.createScoreUninitialized(-7,
                                                                 BigDecimal.valueOf(-147), BigDecimal.valueOf(-258),
                                                                 BigDecimal.valueOf(-369)).toString());
    ...
    public void toInitializedScoreHSS() {
        assertEquals(scoreDefinitionHSS.createScore(BigDecimal.valueOf(-147), BigDecimal.valueOf(-258),
                                                    BigDecimal.valueOf(-369)),
                     scoreDefinitionHSS.createScore(BigDecimal.valueOf(-147), BigDecimal.valueOf(-258),
    ...
    public void withInitScore() {
        assertEquals(scoreDefinitionHSS.createScoreUninitialized(-7, BigDecimal.valueOf(-147), BigDecimal.valueOf(-258),
                                                                 BigDecimal.valueOf(-369)),
                     scoreDefinitionHSS.createScore(BigDecimal.valueOf(-147), BigDecimal.valueOf(-258),
                                                    BigDecimal.valueOf(-369)).withInitScore(-7));
    }
    ...
    public void multiplyHSS() {
        assertEquals(scoreDefinitionHSS.createScoreUninitialized(-14, new BigDecimal("8.6"), new BigDecimal("-10.4"),
                                                                 new BigDecimal("-12.2")),
                     scoreDefinitionHSS.createScoreUninitialized(-7, new BigDecimal("4.3"), new BigDecimal("-5.2"),
                                                                 new BigDecimal("-6.1")).multiply(2.0));
    }
    ...
    public void divideHSS() {
        ...
        assertEquals(scoreDefinitionHSS.createScoreUninitialized(-7, new BigDecimal("4.3"), new BigDecimal("-5.2"),
                                                                 new BigDecimal("-6.1")),
                     scoreDefinitionHSS.createScoreUninitialized(-14, new BigDecimal("8.6"), new BigDecimal("-10.4"),
                                                                 new BigDecimal("-12.2")).divide(2.0));
    }
    ...
    public void powerHSS() {
        ...
        assertEquals(scoreDefinitionHSS.createScoreUninitialized(-343, new BigDecimal("27"), new BigDecimal("-64"),
                                                                 new BigDecimal("125")),
    ...
    public void compareToHSS() {
        PlannerAssert.assertCompareToOrder(
                scoreDefinitionHSS.createScoreUninitialized(-8, new BigDecimal("0"), new BigDecimal("0"),
                                                            new BigDecimal("0")),
                ...
                scoreDefinitionHSS.createScoreUninitialized(-7, new BigDecimal("-1"), new BigDecimal("-300"),
                                                            new BigDecimal("-4000")),
                scoreDefinitionHSS.createScoreUninitialized(-7, new BigDecimal("0"), new BigDecimal("0"),
                                                            new BigDecimal("0")),
                scoreDefinitionHSS.createScoreUninitialized(-7, new BigDecimal("0"), new BigDecimal("0"),
                                                            new BigDecimal("1")),
                scoreDefinitionHSS.createScoreUninitialized(-7, new BigDecimal("0"), new BigDecimal("1"),
                                                            new BigDecimal("0")),
