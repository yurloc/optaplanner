...
public class HardMediumSoftScoreHolderTest extends AbstractScoreHolderTest {
    ...
    public void addConstraintMatch(boolean constraintMatchEnabled) {
        ...
        assertEquals(HardMediumSoftScore.valueOfUninitialized(-7, -7004001, -50020, -600300),
                     scoreHolder.extractScore(-7));
        if (constraintMatchEnabled) {
            assertEquals(HardMediumSoftScore.valueOf(-1, 0, 0),
                         findConstraintMatchTotal(scoreHolder, "hard1").getScoreTotal());
            assertEquals(HardMediumSoftScore.valueOf(0, 0, -300),
