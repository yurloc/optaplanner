...
public class BigIntegerValueRangeTest {
    ...
    public void getSize() {
        ...
        // IncrementUnit
        assertEquals(5L, new BigIntegerValueRange(new BigInteger("0"), new BigInteger("10"),
                                                  new BigInteger("2")).getSize());
        assertEquals(5L, new BigIntegerValueRange(new BigInteger("-1"), new BigInteger("9"),
                                                  new BigInteger("2")).getSize());
        assertEquals(4L, new BigIntegerValueRange(new BigInteger("100"), new BigInteger("120"),
                                                  new BigInteger("5")).getSize());
    }

    @Test
    public void get() {
        assertEquals(new BigInteger("3"), new BigIntegerValueRange(new BigInteger("0"), new BigInteger("10")).get(3L));
        assertEquals(new BigInteger("103"),
                     new BigIntegerValueRange(new BigInteger("100"), new BigInteger("120")).get(3L));
        assertEquals(new BigInteger("-4"),
                     new BigIntegerValueRange(new BigInteger("-5"), new BigInteger("25")).get(1L));
        ...
        assertEquals(new BigInteger("115"),
                     new BigIntegerValueRange(new BigInteger("100"), new BigInteger("120"), new BigInteger("5")).get(
                             3L));
    }
    ...
    public void contains() {
        assertEquals(true,
                     new BigIntegerValueRange(new BigInteger("0"), new BigInteger("10")).contains(new BigInteger("3")));
        assertEquals(false, new BigIntegerValueRange(new BigInteger("0"), new BigInteger("10")).contains(
                new BigInteger("10")));
        assertEquals(false, new BigIntegerValueRange(new BigInteger("0"), new BigInteger("10")).contains(null));
        assertEquals(true, new BigIntegerValueRange(new BigInteger("100"), new BigInteger("120")).contains(
                new BigInteger("100")));
        assertEquals(false, new BigIntegerValueRange(new BigInteger("100"), new BigInteger("120")).contains(
                new BigInteger("99")));
        assertEquals(true, new BigIntegerValueRange(new BigInteger("-5"), new BigInteger("25")).contains(
                new BigInteger("-4")));
        assertEquals(false, new BigIntegerValueRange(new BigInteger("-5"), new BigInteger("25")).contains(
                new BigInteger("-20")));
        // IncrementUnit
        assertEquals(true,
                     new BigIntegerValueRange(new BigInteger("0"), new BigInteger("10"), new BigInteger("2")).contains(
                             new BigInteger("2")));
        assertEquals(false,
                     new BigIntegerValueRange(new BigInteger("0"), new BigInteger("10"), new BigInteger("2")).contains(
                             new BigInteger("3")));
        assertEquals(true,
                     new BigIntegerValueRange(new BigInteger("-1"), new BigInteger("9"), new BigInteger("2")).contains(
                             new BigInteger("1")));
        assertEquals(false,
                     new BigIntegerValueRange(new BigInteger("-1"), new BigInteger("9"), new BigInteger("2")).contains(
                             new BigInteger("2")));
        assertEquals(true, new BigIntegerValueRange(new BigInteger("100"), new BigInteger("120"),
                                                    new BigInteger("5")).contains(new BigInteger("115")));
        assertEquals(false, new BigIntegerValueRange(new BigInteger("100"), new BigInteger("120"),
                                                     new BigInteger("5")).contains(new BigInteger("114")));
    }

    @Test
    public void createOriginalIterator() {
        assertAllElementsOfIterator(new BigIntegerValueRange(new BigInteger("0"), new BigInteger("4"))
                                            .createOriginalIterator(), new BigInteger("0"), new BigInteger("1"),
                                    new BigInteger("2"),
                                    new BigInteger("3"));
        assertAllElementsOfIterator(new BigIntegerValueRange(new BigInteger("100"), new BigInteger("104"))
                                            .createOriginalIterator(), new BigInteger("100"), new BigInteger("101"),
                                    new BigInteger("102"),
                                    new BigInteger("103"));
        assertAllElementsOfIterator(new BigIntegerValueRange(new BigInteger("-4"), new BigInteger("3"))
                                            .createOriginalIterator(), new BigInteger("-4"), new BigInteger("-3"),
                                    new BigInteger("-2"),
