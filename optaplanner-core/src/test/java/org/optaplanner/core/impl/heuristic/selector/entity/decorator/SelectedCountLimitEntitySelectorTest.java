...
public class SelectedCountLimitEntitySelectorTest {
    ...
    public void selectSizeLimitLowerThanSelectorSize() {
        ...
        EntitySelector entitySelector = new RandomSelectionSelectedCountLimitEntitySelector(childEntitySelector, 3L);
    ...
    public void selectSizeLimitHigherThanSelectorSize() {
        ...
        EntitySelector entitySelector = new RandomSelectionSelectedCountLimitEntitySelector(childEntitySelector, 5L);
    ...
    public void endingIteratorOriginalOrder() {
        ...
        EntitySelector entitySelector = new SelectedCountLimitEntitySelector(childEntitySelector, 2L);
    ...
    public void endingIteratorRandomOrder() {
        EntitySelector childEntitySelector = SelectorTestUtils.mockEntitySelector(TestdataEntity.class,
                new TestdataEntity("e1"), new TestdataEntity("e2"), new TestdataEntity("e3"), new TestdataEntity("e4"));
        EntitySelector entitySelector = new RandomSelectionSelectedCountLimitEntitySelector(childEntitySelector, 2L);
