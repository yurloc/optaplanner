...
public class SubChainChangeMoveTest {
    ...
    public void toStringTest() {
        ...
        assertEquals("[a2..a4] {a1 -> b0}", new SubChainChangeMove<>(
                new SubChain(Arrays.<Object>asList(a2, a3, a4)), variableDescriptor, inverseVariableSupply,
                b0).toString());
        assertEquals("[a1..a5] {a0 -> b3}", new SubChainChangeMove<>(
                new SubChain(Arrays.<Object>asList(a1, a2, a3, a4, a5)), variableDescriptor, inverseVariableSupply,
                b3).toString());
        assertEquals("[a1..a3] {a0 -> a5}", new SubChainChangeMove<>(
                new SubChain(Arrays.<Object>asList(a1, a2, a3)), variableDescriptor, inverseVariableSupply,
                a5).toString());
