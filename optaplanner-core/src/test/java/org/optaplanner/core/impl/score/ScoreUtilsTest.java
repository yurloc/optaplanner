...
public class ScoreUtilsTest {
    ...
    public void parseScore() {
        ...
        assertEquals(HardSoftScore.valueOf(-1000, -200),
                     ScoreUtils.parseScore(HardSoftScore.class, "-1000hard/-200soft"));
        assertEquals(HardSoftLongScore.valueOf(-1000L, -200L),
                     ScoreUtils.parseScore(HardSoftLongScore.class, "-1000hard/-200soft"));
        assertEquals(HardSoftDoubleScore.valueOf(-1000.0, -200.0),
        ...
        assertEquals(HardMediumSoftScore.valueOf(-1000, -200, -30),
                     ScoreUtils.parseScore(HardMediumSoftScore.class, "-1000hard/-200medium/-30soft"));
        assertEquals(HardMediumSoftLongScore.valueOf(-1000L, -200L, -30L),
                     ScoreUtils.parseScore(HardMediumSoftLongScore.class, "-1000hard/-200medium/-30soft"));
        assertEquals(BendableScore.valueOf(new int[]{-1000}, new int[]{-200, -30}),
                     ScoreUtils.parseScore(BendableScore.class, "[-1000]hard/[-200/-30]soft"));
        assertEquals(BendableLongScore.valueOf(new long[]{-1000L}, new long[]{-200L, -30L}),
                     ScoreUtils.parseScore(BendableLongScore.class, "[-1000]hard/[-200/-30]soft"));
        assertEquals(BendableBigDecimalScore.valueOf(new BigDecimal[]{new BigDecimal("-1000")},
